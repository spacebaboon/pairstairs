	...
	<body>
		...
		<div id="show-team" class="content scaffold-show" role="main">
			...
			<ol class="property-list team">
				...
				<li class="fieldcontain">
					<span id="coders-label" class="property-label"><g:message code="team.coders.label" default="Coders" /></span>
					
						<g:each in="${teamInstance.coders}" var="c">
						<span class="property-value" aria-labelledby="coders-label"><g:link controller="coder" action="show" id="${c.id}">${c?.name?.encodeAsHTML()}</g:link></span>
						</g:each>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="stairs" action="stairs" id="${teamInstance?.id}"><g:message code="button.stairs.label" default="Stairs" /></g:link>
				</fieldset>
			</g:form>
		</div>
	</body>
